...
const ProjectCard = ({ project, aosDelay }) => (
  ...
  >
    <div className={`rounded-2xl p-6 md:p-8 h-full backdrop-blur-md transition-all duration-500 ${
      ...
      {/* Problem Statement */}
      <div className="mb-4">
        <h4 className="text-red-400 text-xs font-bold uppercase tracking-wider mb-1">Problem Statement:</h4>
      ...
      {/* Key Achievement */}
      <div className="mb-6">
        <h4 className="text-[#ff2a2a] text-xs font-bold uppercase tracking-wider mb-1">Key Achievement:</h4>
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div data-aos="fade-up" className="mb-16 md:mb-20">
          ...
          <p className="text-white/50 text-base md:text-lg max-w-lg font-medium leading-relaxed">
            A selection of projects that showcase my expertise in data analytics, visualization, and AI-powered solutions.
          </p>
        </div>
